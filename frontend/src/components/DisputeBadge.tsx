...
const MAP: Record<string, { color: string; label: string }> = {
  disputed: { color: "var(--disp-disputed)", label: "Disputed" },
  resolved_in_favor: { color: "var(--disp-resolved-for)", label: "Resolved (for)" },
  resolved_against: { color: "var(--disp-resolved-against)", label: "Resolved (against)" },
};
